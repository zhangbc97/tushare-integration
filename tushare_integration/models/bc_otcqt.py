...
class BcOtcqt(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'trade_date': {'type': 'str', 'required': False, 'description': ''}, 'start_date': {'type': 'str', 'required': False, 'description': ''}, 'end_date': {'type': 'str', 'required': False, 'description': ''}, 'ts_code': {'type': 'str', 'required': False, 'description': ''}, 'bank': {'type': 'str', 'required': False, 'description': ''}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    buy_price = Column('buy_price', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='投资者买入全价')
    sell_price = Column('sell_price', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='投资者卖出全价')
    buy_yield = Column('buy_yield', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='投资者买入到期收益率(%)')
    sell_yield = Column('sell_yield', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='投资者卖出到期收益率(%)')