...
class SlbLenMm(Base):
    ...
    __tablename__: str = 'slb_len_mm'
    __api_id__: ClassVar[int] = 334
    __api_name__: ClassVar[str] = 'slb_len_mm'
    __api_title__: ClassVar[str] = '做市借券交易汇总'
    __api_info_title__: ClassVar[str] = '做市借券交易汇总'
    __api_path__: ClassVar[List[str]] = ['数据接口', '沪深股票', '两融及转融通', '做市借券交易汇总']
    __api_path_ids__: ClassVar[List[int]] = [2, 14, 330, 334]
    __api_points_required__: ClassVar[int] = 2000
    __api_special_permission__: ClassVar[bool] = False
    __has_vip__: ClassVar[bool] = False
    __dependencies__: ClassVar[List[str]] = ['trade_cal']
    __primary_key__: ClassVar[List[str]] = ['ts_code', 'trade_date']
    __start_date__: ClassVar[str | None] = '2022-11-14'
    ...
    lent_qnt = Column(
        'lent_qnt', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='融出数量(万股)'
    )
    cls_inv = Column(
