...
class StkWeeklyMonthly(Base):
    ...
    pre_close = Column('pre_close', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='上一(周/月)收盘价')
    ...
    pct_chg = Column('pct_chg', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='(周/月)涨跌幅(未复权,如果是复权请用 通用行情接口)')