...
class Coinexchanges(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'exchange': {'type': 'str', 'required': False, 'description': '交易所'}, 'area_code': {'type': 'str', 'required': False, 'description': '地区'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    area_code = Column('area_code', String(), nullable=False, default="", server_default=text("''"), comment='所在地区代码')
    area = Column('area', String(), nullable=False, default="", server_default=text("''"), comment='所在地区')
    coin_trade = Column('coin_trade', String(), nullable=False, default="", server_default=text("''"), comment='支持现货交易')
    fut_trade = Column('fut_trade', String(), nullable=False, default="", server_default=text("''"), comment='支持期货交易')
    oct_trade = Column('oct_trade', String(), nullable=False, default="", server_default=text("''"), comment='支持场外交易')
    deep_share = Column('deep_share', String(), nullable=False, default="", server_default=text("''"), comment='支持共享交易深度')
    mineable = Column('mineable', String(), nullable=False, default="", server_default=text("''"), comment='支持挖矿交易')
    ...
    twitter = Column('twitter', String(), nullable=False, default="", server_default=text("''"), comment='交易所twitter')
    facebook = Column('facebook', String(), nullable=False, default="", server_default=text("''"), comment='交易所facebook')
