...
class SgeDaily(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'ts_code': {'type': 'str', 'required': False, 'description': '合约代码'}, 'trade_date': {'type': 'str', 'required': False, 'description': '交易日期'}, 'start_date': {'type': 'str', 'required': False, 'description': '开始日期'}, 'end_date': {'type': 'str', 'required': False, 'description': '结束日期'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    ts_code = Column('ts_code', String(16), nullable=False, default="", server_default=text("''"), comment='现货合约代码')
    ...
    price_avg = Column('price_avg', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='昨日收盘点')
    ...
    settle_vol = Column('settle_vol', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='交收量')
    settle_dire = Column('settle_dire', String(), nullable=False, default="", server_default=text("''"), comment='持仓方向')