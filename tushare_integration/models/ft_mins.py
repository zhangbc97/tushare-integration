...
class FtMins(Base):
    ...
    __tablename__: str = 'ft_mins'
    __api_id__: ClassVar[int] = 313
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'ts_code': {'type': 'str', 'required': False, 'description': 'ts_code'}, 'freq': {'type': 'str', 'required': False, 'description': '分钟频度'}, 'start_date': {'type': 'datetime', 'required': False, 'description': '开始时间'}, 'end_date': {'type': 'datetime', 'required': False, 'description': '结束时间'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
