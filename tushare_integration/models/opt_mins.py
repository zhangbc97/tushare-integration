...
class OptMins(Base):
    ...
    __tablename__: str = 'opt_mins'
    __api_id__: ClassVar[int] = 341
    __api_name__: ClassVar[str] = 'opt_mins'
    __api_title__: ClassVar[str] = '期权分钟行情'
    __api_info_title__: ClassVar[str] = '期权分钟'
    __api_path__: ClassVar[List[str]] = ['数据接口', '期权', '期权分钟行情']
    __api_path_ids__: ClassVar[List[int]] = [2, 157, 341]
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'ts_code': {'type': 'str', 'required': True, 'description': 'ts_code'}, 'freq': {'type': 'str', 'required': True, 'description': '分钟频度'}, 'start_date': {'type': 'datetime', 'required': False, 'description': ''}, 'end_date': {'type': 'datetime', 'required': False, 'description': '结束时间'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
