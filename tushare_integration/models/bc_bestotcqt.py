...
class BcBestotcqt(Base):
    ...
    best_buy_bank = Column(
        'best_buy_bank', String(), nullable=False, default="", server_default=text("''"), comment='最优报买价方'
    )
    best_buy_yield = Column(
        'best_buy_yield',
        Float,
        nullable=False,
        default=0.0,
        server_default=text("'0.0'"),
        comment='投资者最优买入价到期收益率(%)',
    )
    best_buy_price = Column(
        'best_buy_price', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='投资者最优买入全价'
    )
    best_sell_bank = Column(
        'best_sell_bank', String(), nullable=False, default="", server_default=text("''"), comment='最优卖报价方'
    )
    best_sell_yield = Column(
        'best_sell_yield',
        Float,
        nullable=False,
        default=0.0,
        server_default=text("'0.0'"),
        comment='投资者最优卖出价到期收益率(%)',
    )
    best_sell_price = Column(
        'best_sell_price',
        Float,
        nullable=False,
        default=0.0,
