...
class StkMins(Base):
    ...
    __api_title__: ClassVar[str] = '分钟线行情'
    __api_info_title__: ClassVar[str] = '分钟线行情'
    __api_path__: ClassVar[List[str]] = ['数据接口', '沪深股票', '行情数据', '分钟线行情']
    __api_path_ids__: ClassVar[List[int]] = [2, 14, 15, -1]
