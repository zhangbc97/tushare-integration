...
class FutMapping(Base):
    ...
    ts_code = Column('ts_code', String(16), nullable=False, default="", server_default=text("''"), comment='连续合约代码')
    trade_date = Column('trade_date', Date, nullable=False, default="1970-01-01", server_default=text("'1970-01-01'"), comment='起始日期')
    mapping_ts_code = Column('mapping_ts_code', String(), nullable=False, default="", server_default=text("''"), comment='期货合约代码')