...
class Bishijie(Base):
    ...
    __tablename__: str = 'bishijie'
    __api_id__: ClassVar[int] = 73
    __api_name__: ClassVar[str] = 'bishijie'
    __api_title__: ClassVar[str] = '币世界'
    __api_info_title__: ClassVar[str] = '币世界'
    __api_path__: ClassVar[List[str]] = ['另类数据', '资讯公告', '币世界']
    __api_path_ids__: ClassVar[List[int]] = [41, 69, 73]
