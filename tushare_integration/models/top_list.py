...
class TopList(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'trade_date': {'type': 'str', 'required': True, 'description': '交易日期'}, 'ts_code': {'type': 'str', 'required': False, 'description': '股票代码'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    l_amount = Column('l_amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='龙虎榜成交额')
    net_amount = Column('net_amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='龙虎榜净买入额')
    net_rate = Column('net_rate', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='龙虎榜净买额占比')
    amount_rate = Column('amount_rate', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='龙虎榜成交额占比')
    float_values = Column('float_values', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='当日流通市值')
