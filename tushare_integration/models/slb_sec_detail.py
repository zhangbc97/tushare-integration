...
class SlbSecDetail(Base):
    """转融券交易明细"""

    __tablename__: str = 'slb_sec_detail'
    __api_id__: ClassVar[int] = 333
    __api_name__: ClassVar[str] = 'slb_sec_detail'
    __api_title__: ClassVar[str] = '转融券交易明细'
    __api_info_title__: ClassVar[str] = '转融券交易明细'
    __api_path__: ClassVar[List[str]] = ['数据接口', '沪深股票', '两融及转融通', '转融券交易明细']
    ...
    fee_rate = Column('fee_rate', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='融出费率(%)')
