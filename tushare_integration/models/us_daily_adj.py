...
class UsDailyAdj(Base):
    ...
    __api_path__: ClassVar[List[str]] = ['数据接口', '美股数据', '美股复权行情']
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {
        ...
        'exchange': {'type': 'str', 'required': False, 'description': '交易所（NAS/NYS/OTC)'},
    ...
    free_share = Column(
        'free_share', Integer, nullable=False, default=0, server_default=text("'0'"), comment='流通股本'
    )
    total_share = Column(
        'total_share', Integer, nullable=False, default=0, server_default=text("'0'"), comment='总股本'
    )
