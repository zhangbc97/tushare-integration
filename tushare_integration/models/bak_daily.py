...
class BakDaily(Base):
    ...
    __start_date__: ClassVar[str | None] = '2017-06-14'
    ...
    total_share = Column(
        'total_share', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='总股本(万)'
    )
    float_share = Column(
        'float_share', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='流通股本(万)'
    )
    ...
    avg_turnover = Column(
        'avg_turnover', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='笔换手'
    )
    attack = Column('attack', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='攻击波(%)')
    interval_3 = Column(
        'interval_3', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='近3月涨幅'
    )
    interval_6 = Column(
        'interval_6', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='近6月涨幅'
    )
