...
class GgtDaily(Base):
    ...
    __api_path__: ClassVar[List[str]] = ['数据接口', '沪深股票', '行情数据', '港股通每日成交统计']
    ...
    buy_amount = Column('buy_amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='买入成交金额(亿元)')
    buy_volume = Column('buy_volume', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='买入成交笔数(万笔)')
    sell_amount = Column('sell_amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='卖出成交金额(亿元)')
    sell_volume = Column('sell_volume', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='卖出成交笔数(万笔)')