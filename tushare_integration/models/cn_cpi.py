...
class CnCpi(Base):
    ...
    town_val = Column('town_val', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='城市当值月')
    town_yoy = Column('town_yoy', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='城市同比(%)')
    town_mom = Column('town_mom', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='城市环比(%)')
    town_accu = Column('town_accu', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='城市累计值')
    ...
    cnt_accu = Column('cnt_accu', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='农村累计值')