...
class GgtTop10(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'ts_code': {'type': 'str', 'required': False, 'description': '股票代码'}, 'trade_date': {'type': 'str', 'required': False, 'description': '交易日期'}, 'start_date': {'type': 'str', 'required': False, 'description': '开始日期'}, 'end_date': {'type': 'str', 'required': False, 'description': '结束日期'}, 'market_type': {'type': 'str', 'required': False, 'description': '市场类型 2：港股通（沪） 4：港股通（深）'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    market_type = Column('market_type', String(), nullable=False, default="", server_default=text("''"), comment='市场类型 2：港股通(沪) 4：港股通(深)')
    amount = Column('amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='累计成交金额')
    net_amount = Column('net_amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='净买入金额')
    sh_amount = Column('sh_amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='沪市成交金额')
    sh_net_amount = Column('sh_net_amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='沪市净买入金额')
    sh_buy = Column('sh_buy', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='沪市买入金额')
    sh_sell = Column('sh_sell', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='沪市卖出金额')
    sz_amount = Column('sz_amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='深市成交金额')
    sz_net_amount = Column('sz_net_amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='深市净买入金额')
    sz_buy = Column('sz_buy', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='深市买入金额')
    sz_sell = Column('sz_sell', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='深市卖出金额')