...
class DailyBasic(Base):
    ...
    free_share = Column('free_share', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='自由流通股本')
    ...
    limit_status = Column('limit_status', Integer, nullable=False, default=0, server_default=text("'0'"), comment='涨跌停状态')