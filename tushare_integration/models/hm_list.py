...
class HmList(Base):
    ...
    __tablename__: str = 'hm_list'
    __api_id__: ClassVar[int] = 311
    __api_name__: ClassVar[str] = 'hm_list'
    __api_title__: ClassVar[str] = '市场游资最全名录'
    __api_info_title__: ClassVar[str] = '游资名录'
    __api_path__: ClassVar[List[str]] = ['数据接口', '沪深股票', '打板专题数据', '市场游资最全名录']
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'name': {'type': 'str', 'required': False, 'description': '游资名称'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
