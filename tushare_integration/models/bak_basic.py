...
class BakBasic(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'trade_date': {'type': 'str', 'required': False, 'description': '交易日期'}, 'ts_code': {'type': 'str', 'required': False, 'description': '股票代码'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    float_share = Column('float_share', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='流通股本(亿)')
    total_share = Column('total_share', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='总股本(亿)')
    total_assets = Column('total_assets', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='总资产(亿)')
    liquid_assets = Column('liquid_assets', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='流动资产(亿)')
    fixed_assets = Column('fixed_assets', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='固定资产(亿)')
    reserved = Column('reserved', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='公积金')
    reserved_pershare = Column('reserved_pershare', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='每股公积金')
    ...
    per_undp = Column('per_undp', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='每股未分配利润')
    rev_yoy = Column('rev_yoy', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='收入同比(%)')
    profit_yoy = Column('profit_yoy', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='利润同比(%)')
    ...
    holder_num = Column('holder_num', Integer, nullable=False, default=0, server_default=text("'0'"), comment='股东人数')