...
class CnM(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'m': {'type': 'str', 'required': False, 'description': '月度（202001表示，2020年1月）'}, 'start_m': {'type': 'str', 'required': False, 'description': '开始月度'}, 'end_m': {'type': 'str', 'required': False, 'description': '结束月度'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
