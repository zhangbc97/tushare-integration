...
class FtTick(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'symbol': {'type': 'str', 'required': True, 'description': '期货期权代码'}, 'start_date': {'type': 'datetime', 'required': False, 'description': '开始时间'}, 'end_date': {'type': 'datetime', 'required': False, 'description': '结束时间'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
