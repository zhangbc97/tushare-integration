...
class AnnsD(Base):
    ...
    rec_time = Column('rec_time', DateTime, nullable=False, default="1970-01-01 00:00:00", server_default=text("'1970-01-01 00:00:00'"), comment='发布时间')