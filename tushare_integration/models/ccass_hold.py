...
class CcassHold(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'ts_code': {'type': 'str', 'required': False, 'description': '股票代码'}, 'trade_date': {'type': 'str', 'required': False, 'description': '交易日期'}, 'start_date': {'type': 'str', 'required': False, 'description': '开始日期'}, 'end_date': {'type': 'str', 'required': False, 'description': '结束日期'}, 'type': {'type': 'str', 'required': False, 'description': '类型'}, 'hk_hold': {'type': 'str', 'required': False, 'description': '港交所代码'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    shareholding = Column('shareholding', String(), nullable=False, default="", server_default=text("''"), comment='于中央结算系统的持股量(股)')
    hold_nums = Column('hold_nums', String(), nullable=False, default="", server_default=text("''"), comment='参与者数目(个)')
    hold_ratio = Column('hold_ratio', String(), nullable=False, default="", server_default=text("''"), comment='占于上交所/深交所上市及交易的A股总数的百分比(%)')