...
class HsConst(Base):
    ...
    __primary_key__: ClassVar[List[str]] = ['ts_code', 'hs_type', 'in_date']
    __start_date__: ClassVar[str | None] = None
    __end_date__: ClassVar[str | None] = None
    __api_params__: ClassVar[Dict[str, Any]] = {
        'hs_type': {'type': 'str', 'required': True, 'description': '类型SH沪股通SZ深股通'},
        'is_new': {'type': 'str', 'required': False, 'description': '是否最新1最新0不是'},
    ...
    hs_type = Column(
        'hs_type', String(), nullable=False, default="", server_default=text("''"), comment='沪深港通类型SH沪SZ深'
    )
    in_date = Column(
