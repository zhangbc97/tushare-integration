...
class ConceptDetail(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'id': {'type': 'str', 'required': False, 'description': '概念分类ID'}, 'ts_code': {'type': 'str', 'required': False, 'description': '股票代码'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    concept_name = Column('concept_name', String(), nullable=False, default="", server_default=text("''"), comment='概念名称')
