...
class LimitStep(Base):
    ...
    __tablename__: str = 'limit_step'
    __api_id__: ClassVar[int] = 356
    __api_name__: ClassVar[str] = 'limit_step'
    __api_title__: ClassVar[str] = '涨停股票连板天梯'
    __api_info_title__: ClassVar[str] = '连板天梯'
    __api_path__: ClassVar[List[str]] = ['数据接口', '沪深股票', '打板专题数据', '涨停股票连板天梯']
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'trade_date': {'type': 'str', 'required': False, 'description': '交易日期'}, 'ts_code': {'type': 'str', 'required': False, 'description': '股票代码'}, 'start_date': {'type': 'str', 'required': False, 'description': '开始日期'}, 'end_date': {'type': 'str', 'required': False, 'description': '结束日期'}, 'nums': {'type': 'str', 'required': False, 'description': '连板次数'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
