...
class StkAuctionO(Base):
    ...
    close = Column('close', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='开盘集合竞价收盘价')
    open = Column('open', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='开盘集合竞价开盘价')
    high = Column('high', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='开盘集合竞价最高价')
    ...
    amount = Column('amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='开盘集合竞价成交额')
