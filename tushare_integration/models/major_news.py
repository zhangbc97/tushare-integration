...
class MajorNews(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'src': {'type': 'str', 'required': False, 'description': '新闻来源'}, 'start_date': {'type': 'datetime', 'required': False, 'description': '新闻发布开始时间'}, 'end_date': {'type': 'datetime', 'required': False, 'description': '新闻发布结束时间'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
