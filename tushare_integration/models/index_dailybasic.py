...
class IndexDailybasic(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'trade_date': {'type': 'str', 'required': False, 'description': '交易日期'}, 'ts_code': {'type': 'str', 'required': False, 'description': 'TS指数代码'}, 'start_date': {'type': 'str', 'required': False, 'description': '开始日期'}, 'end_date': {'type': 'str', 'required': False, 'description': '结束日期'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    total_mv = Column('total_mv', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='当日总市值')
    float_mv = Column('float_mv', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='当日流通市值')
    total_share = Column('total_share', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='当日总股本')
    float_share = Column('float_share', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='当日流通股本')
    free_share = Column('free_share', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='当日自由流通股本')
    turnover_rate = Column('turnover_rate', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='换手率')
    turnover_rate_f = Column('turnover_rate_f', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='换手率(自由流通股本)')
