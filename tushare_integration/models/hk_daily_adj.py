...
class HkDailyAdj(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'ts_code': {'type': 'str', 'required': False, 'description': '股票代码（e.g. 00001.HK）'}, 'trade_date': {'type': 'str', 'required': False, 'description': '交易日期（YYYYMMDD）'}, 'start_date': {'type': 'str', 'required': False, 'description': '开始日期（YYYYMMDD）'}, 'end_date': {'type': 'str', 'required': False, 'description': '结束日期（YYYYMMDD）'}, 'offset': {'type': 'int', 'required': False, 'description': '开始行数'}, 'limit': {'type': 'int', 'required': False, 'description': '每页行数行数'}, 'symbol': {'type': 'str', 'required': False, 'description': ''}}
    ...
    free_share = Column('free_share', String(), nullable=False, default="", server_default=text("''"), comment='流通股本')
    total_share = Column('total_share', String(), nullable=False, default="", server_default=text("''"), comment='总股本')
