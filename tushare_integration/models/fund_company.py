...
class FundCompany(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'setup_date': {'type': 'str', 'required': False, 'description': '成立日期'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    short_enname = Column('short_enname', String(), nullable=False, default="", server_default=text("''"), comment='英文缩写')
    ...
    setup_date = Column('setup_date', Date, nullable=False, default="1970-01-01", server_default=text("'1970-01-01'"), comment='成立日期')
    end_date = Column('end_date', Date, nullable=False, default="1970-01-01", server_default=text("'1970-01-01'"), comment='公司终止日期')
    employees = Column('employees', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='员工总数')
    main_business = Column('main_business', String(), nullable=False, default="", server_default=text("''"), comment='主要产品及业务')
    org_code = Column('org_code', String(), nullable=False, default="", server_default=text("''"), comment='组织机构代码')
    credit_code = Column('credit_code', String(), nullable=False, default="", server_default=text("''"), comment='统一社会信用代码')