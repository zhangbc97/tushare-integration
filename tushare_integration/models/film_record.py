...
class FilmRecord(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'ann_date': {'type': 'str', 'required': False, 'description': '公布日期'}, 'start_date': {'type': 'str', 'required': False, 'description': '开始日期'}, 'end_date': {'type': 'str', 'required': False, 'description': '结束日期'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    script_writer = Column('script_writer', String(), nullable=False, default="", server_default=text("''"), comment='编剧')
    rec_result = Column('rec_result', String(), nullable=False, default="", server_default=text("''"), comment='备案结果')
    rec_area = Column('rec_area', String(), nullable=False, default="", server_default=text("''"), comment='备案地')
    classified = Column('classified', String(), nullable=False, default="", server_default=text("''"), comment='影片分类')
    date_range = Column('date_range', String(), nullable=False, default="", server_default=text("''"), comment='备案日期')
    ann_date = Column('ann_date', Date, nullable=False, default="1970-01-01", server_default=text("'1970-01-01'"), comment='备案结果发布时间')