...
class FundNav(Base):
    ...
    __primary_key__: ClassVar[List[str]] = ['ts_code', 'nav_date']
    __start_date__: ClassVar[str | None] = None
    __end_date__: ClassVar[str | None] = None
    __api_params__: ClassVar[Dict[str, Any]] = {
        'ts_code': {'type': 'str', 'required': False, 'description': 'TS基金代码'},
        'nav_date': {'type': 'str', 'required': False, 'description': '净值日期'},
        'offset': {'type': 'int', 'required': False, 'description': ''},
        'limit': {'type': 'int', 'required': False, 'description': ''},
        'market': {'type': 'str', 'required': False, 'description': 'E场内O场外'},
        'start_date': {'type': 'str', 'required': False, 'description': '净值开始日期'},
        'end_date': {'type': 'str', 'required': False, 'description': '净值结束日期'},
    }
