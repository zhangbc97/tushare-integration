...
class DcHot(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'trade_date': {'type': 'str', 'required': False, 'description': '交易日期'}, 'ts_code': {'type': 'str', 'required': False, 'description': 'TS代码'}, 'market': {'type': 'str', 'required': False, 'description': '热板类型(A股市场、ETF基金、港股市场、美股市场)'}, 'hot_type': {'type': 'str', 'required': False, 'description': '热点类型(人气榜、飙升榜)'}, 'is_new': {'type': 'str', 'required': False, 'description': '是否最新'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
