...
class HkBasic(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'ts_code': {'type': 'str', 'required': False, 'description': 'TS代码'}, 'list_status': {'type': 'str', 'required': False, 'description': '上市状态 L上市 D退市 P暂停上市'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    list_status = Column('list_status', String(), nullable=False, default="", server_default=text("''"), comment='上市状态')
    ...
    trade_unit = Column('trade_unit', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='交易单位')
