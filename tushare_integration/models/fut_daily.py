...
class FutDaily(Base):
    ...
    trade_date = Column('trade_date', Date, nullable=False, default="1970-01-01", server_default=text("'1970-01-01'"), comment='交易代码')
    pre_close = Column('pre_close', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='昨收盘价')
    pre_settle = Column('pre_settle', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='昨结算价')
    ...
    change1 = Column('change1', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='涨跌1,收盘价-昨结算价')
    change2 = Column('change2', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='涨跌2,结算价-昨结算价')
    ...
    delv_settle = Column('delv_settle', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='交割结算价')