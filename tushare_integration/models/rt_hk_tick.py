...
class RtHkTick(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'topic': {'type': 'str', 'required': False, 'description': ''}, 'ts_code': {'type': 'str', 'required': True, 'description': '逗号隔开多个code'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    trade_time = Column('trade_time', String(), nullable=False, default="", server_default=text("''"), comment='交易日期')
    ...
    open_interest = Column('open_interest', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='')
