...
class Coinpair(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'trade_date': {'type': 'str', 'required': False, 'description': '日期'}, 'exchange': {'type': 'str', 'required': True, 'description': '交易所'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    exchange_pair = Column('exchange_pair', String(), nullable=False, default="", server_default=text("''"), comment='交易所原始交易对名称')
    ts_pair = Column('ts_pair', String(), nullable=False, default="", server_default=text("''"), comment='Tushare标准名称')