...
class StockMx(Base):
    ...
    mx_grade = Column('mx_grade', Integer, nullable=False, default=0, server_default=text("'0'"), comment='动能评级，综合动能指标后分成4个评等，1(高)、2(中)、3(低)、4(弱)')
    com_stock = Column('com_stock', String(), nullable=False, default="", server_default=text("''"), comment='行业轮动指标')
    evd_v = Column('evd_v', String(), nullable=False, default="", server_default=text("''"), comment='速度指标，衡量该个股股价变化的速度')
    zt_sum_z = Column('zt_sum_z', String(), nullable=False, default="", server_default=text("''"), comment='极值，短期均线离差值')
    wma250_z = Column('wma250_z', String(), nullable=False, default="", server_default=text("''"), comment='偏离指标，中期均线偏离度指标')