...
class BoCinema(Base):
    ...
    day_amount = Column('day_amount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='当日票房')
    day_showcount = Column('day_showcount', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='当日场次')
    avg_price = Column('avg_price', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='场均票价(元)')
