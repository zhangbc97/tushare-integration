...
class FxObasic(Base):
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {'exchange': {'type': 'str', 'required': False, 'description': '交易商'}, 'classify': {'type': 'str', 'required': False, 'description': '分类'}, 'ts_code': {'type': 'str', 'required': False, 'description': 'TS代码'}, 'limit': {'type': 'int', 'required': False, 'description': '单次返回数据长度'}, 'offset': {'type': 'int', 'required': False, 'description': '请求数据的开始位移量'}}
    ...
    min_unit = Column('min_unit', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='最小交易单位')
    max_unit = Column('max_unit', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='最大交易单位')
    ...
    traget_spread = Column('traget_spread', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='目标差价')
    min_stop_distance = Column('min_stop_distance', Float, nullable=False, default=0.0, server_default=text("'0.0'"), comment='最小止损距离(点子)')
    trading_hours = Column('trading_hours', String(), nullable=False, default="", server_default=text("''"), comment='交易时间')
    break_time = Column('break_time', String(), nullable=False, default="", server_default=text("''"), comment='休市时间')