...
cookie = 'session-id=5403d349-71dc-4616-8e5e-bc072ebb40e2; uid="2|1:0|10:1740378347|3:uid|4:MzM=|4b50ac82c20f9b01c47e691249ec0b20cb2b0515b86bece104cfef3ad4115114"; username=2|1:0|10:1740378347|8:username|12:56ug5LiZ6L6w|a630a2558f9fcf90cfb2ed18b41f68469692743c8f63b9d04036ddd9835d5d98'
# SQLAlchemy模型模板
...
def extract_class_attributes(file_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        patterns = {
            ...
            'has_vip': r'__has_vip__:\s*ClassVar\[bool\]\s*=\s*(True|False)',
...
def generate_model(api_id: int, output_dir: str):
    ...
    template_vars = {
        ...
        'has_vip': existing_attrs.get('has_vip', False),
